...
<html>
	<head>
		...
		<meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1"> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css"> <link rel="stylesheet" type="text/css" href="styleIndex.css"> <link rel="stylesheet" type="text/css" href="style.css"> 
						...
						<div class="collapse navbar-collapse" id="main-navigation">
							<ul class="navbar-nav">
								...
								<div class="col-lg-1">
									<li class="nav-item">
										<div class="dropdown">
											<p data-toggle="dropdown" class="nav-link" style="color:white;">
												Achat
											</p>
											<div class="dropdown-menu">
												<div class="dropdown-item">
													<a class="nav-link" href="encherir.php">
														Enchère
													</a>
												</div>
												<div class="dropdown-item">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							...
							<p>
								37, quai de Grenelle, 75015 Paris, France <br> info@webDynamique.ece.fr <br> +33 01 02 03 04 05 <br> +33 01 03 02 05 04 
							</p>
						</div>
					</div>
				</div>
				<div class="footer-copyright text-center">
					&copy; 2020 Copyright | Droit d'auteur: ProjetVG-PC-NT
				</div>
			</footer>
	</body>
</html>
